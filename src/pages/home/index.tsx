...
export function Home() {
  ...
  async function handleSearchCar(){
    ...
    return (
        <Container>
          <section className="bg-white p-4 rounded-lg w-full mx-auto flex justify-center items-center gap-2">
            ...
            {cars.map( car => (
              <Link key={car.id} to={`/car/${car.id}`} >
                <section className="w-full bg-white rounded-lg">
                  <div 
                    className="w-full rounded-lg h-72 bg-slate-200 mb-2"
                  ...
                  <div 
                      className="w-full h-px bg-slate-200 mb-2">
                  </div>
